class Conf:
    ...
    quotes_better = [ 
        {      
            "text":"It’s time for you to look inward and start asking yourself the big question: who are you and what do you want?",
        ...
        {
            "text":"Good times become good memories, but bad times become good lessons.",
            "author":"Uncle Iroh (ATLA)"
        },
        {
        ...
        {
            "text":"While it is always best to believe in one’s self, a little help from others can be a great blessing.",
            "author":"Uncle Iroh (ATLA)"
        },
        {
        ...
        {
            "text":"Perfection and power are overrated. I think you are very wise to choose happiness and love.",
            "author":"Uncle Iroh (ATLA)"
        },
        {
            "text":"I suggest you think about what it is that you want from your life, and why.",
            "author":"Uncle Iroh (ATLA)"
        },
        {
        ...
        {
            "text":"Understanding others, the other elements, the other nations, will help you become whole.",
            "author":"Uncle Iroh (ATLA)"
        },
        {
            "text":"I know you’re not supposed to cry over spilled tea, but it’s just so sad!",
            "author":"Uncle Iroh (ATLA)"
        },
        {
            "text":"Who would have thought that, after all these years, I would return to the scene of my greatest military disgrace…as a tourist!",
            "author":"Uncle Iroh (ATLA)"
        },
        {
            "text":"Zuko, it’s time we had a talk…about your hair. It’s gone too far!",
            "author":"Uncle Iroh (ATLA)"
        },
        {
            "text":"Ick! This tea is nothing more than hot leaf juice!",
            "author":"Uncle Iroh (ATLA)"
        },
        {
            "text":"The only thing better than finding something you are looking for is finding something you weren’t looking for...at a great bargain!",
            "author":"Uncle Iroh (ATLA)"
        },
        {
            "text":"It’s a lovely night for a walk. Why don’t you join me? It would clear your head. Or, just stay in your room and sit in the dark. Whatever makes you happy.",
            "author":"Uncle Iroh (ATLA)"
        }
    ]
